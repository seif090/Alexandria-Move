        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvitedEmail = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InvitedPhone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommunityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    StartLocation = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    EndLocation = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Routes_Communities_CommunityId",
                        column: x => x.CommunityId,
                        principalTable: "Communities",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AffectedFields = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CancellationRate = table.Column<double>(type: "float", nullable: true),
                    SafetyScore = table.Column<double>(type: "float", nullable: true),
                    IsVerified = table.Column<bool>(type: "bit", nullable: false),
                    IsAvailable = table.Column<bool>(type: "bit", nullable: false),
                    Status = table.Column<int>(type: "int", maxLength: 30, nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Type = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    Event = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatedEntityType = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    EstimatedArrivalTime = table.Column<double>(type: "float", nullable: true),
                    EstimatedArrivalMinutes = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransportationGroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TransportationGroups_Communities_CommunityId",
                        column: x => x.CommunityId,
                        principalTable: "Communities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TransportationGroups_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_TransportationGroups_Routes_RouteId",
                        column: x => x.RouteId,
                        principalTable: "Routes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_TransportationGroups_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QrCodeToken = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_TransportationGroups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TransportationGroupId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Trips_TransportationGroups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "TransportationGroups",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Trips_TransportationGroups_TransportationGroupId",
                        column: x => x.TransportationGroupId,
                        principalTable: "TransportationGroups",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDroppedOff = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TripPassengers_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "DeletedAt", "DeletedBy", "Description", "IsDefault", "IsDeleted", "IsSystemRole", "Name", "UpdatedAt", "UpdatedBy" },
                values: new object[,]
                {
                    { new Guid("a1b2c3d4-e5f6-7890-abcd-ef1234567890"), new DateTime(2026, 6, 29, 12, 44, 11, 622, DateTimeKind.Utc).AddTicks(5774), null, null, null, "Full system access", false, false, true, "SuperAdmin", null, null },
                    { new Guid("b2c3d4e5-f6a7-8901-bcde-f12345678901"), new DateTime(2026, 6, 29, 12, 44, 11, 622, DateTimeKind.Utc).AddTicks(5779), null, null, null, "Community administration", false, false, true, "CommunityAdmin", null, null },
                    { new Guid("c3d4e5f6-a7b8-9012-cdef-123456789012"), new DateTime(2026, 6, 29, 12, 44, 11, 622, DateTimeKind.Utc).AddTicks(5781), null, null, null, "Regular passenger", false, false, true, "Passenger", null, null },
                    { new Guid("d4e5f6a7-b8c9-0123-def1-234567890123"), new DateTime(2026, 6, 29, 12, 44, 11, 622, DateTimeKind.Utc).AddTicks(5783), null, null, null, "Vehicle driver", false, false, true, "Driver", null, null },
                    { new Guid("e5f6a7b8-c9d0-1234-ef12-345678901234"), new DateTime(2026, 6, 29, 12, 44, 11, 622, DateTimeKind.Utc).AddTicks(5785), null, null, null, "Company administrator", false, false, true, "CompanyAdmin", null, null },
                    { new Guid("f6a7b8c9-d0e1-2345-f123-456789012345"), new DateTime(2026, 6, 29, 12, 44, 11, 622, DateTimeKind.Utc).AddTicks(5787), null, null, null, "School administrator", false, false, true, "SchoolAdmin", null, null }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AccessFailedCount", "Address", "CreatedAt", "CreatedBy", "DateOfBirth", "DeletedAt", "DeletedBy", "Email", "FullName", "Gender", "IsDeleted", "IsVerified", "LastLogin", "LockoutEnd", "PasswordHash", "PhoneNumber", "ProfileImageUrl", "RefreshToken", "RefreshTokenExpiryTime", "RegistrationDate", "Status", "TwoFactorEnabled", "UpdatedAt", "UpdatedBy" },
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), 0, null, new DateTime(2026, 6, 29, 12, 44, 11, 785, DateTimeKind.Utc).AddTicks(4385), null, null, null, null, "admin@alexandria.com", "Super Admin", null, false, true, null, null, "$2a$11$Ie7ck2HINinE15BkqQKwHObJtIijDc1wey5CxGfRqq/BltRUP/Ojm", "+201234567890", null, null, null, new DateTime(2026, 6, 29, 12, 44, 11, 785, DateTimeKind.Utc).AddTicks(4381), "Active", false, null, null });

            migrationBuilder.InsertData(
                table: "UserRoles",
                columns: new[] { "RoleId", "UserId", "AssignedAt" },
                values: new object[] { new Guid("a1b2c3d4-e5f6-7890-abcd-ef1234567890"), new Guid("00000000-0000-0000-0000-000000000001"), new DateTime(2026, 6, 29, 12, 44, 11, 785, DateTimeKind.Utc).AddTicks(4895) });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommunityInvitations_InvitedEmail",
                table: "CommunityInvitations",
                column: "InvitedEmail");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_RatedEntityId_RatedEntityType",
                table: "Ratings",
                columns: new[] { "RatedEntityId", "RatedEntityType" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePermissions_RoleId_PermissionGroup_PermissionName",
                table: "RolePermissions",
                columns: new[] { "RoleId", "PermissionGroup", "PermissionName" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stops_RouteId_OrderIndex",
                table: "Stops",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_UserId_CommunityId",
                table: "Subscriptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransportationGroups_CommunityId",
                table: "TransportationGroups",
                column: "CommunityId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportationGroups_DriverId",
                table: "TransportationGroups",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportationGroups_RouteId",
                table: "TransportationGroups",
                column: "RouteId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportationGroups_VehicleId",
                table: "TransportationGroups",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_TripPassengers_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trips_TransportationGroupId",
                table: "Trips",
                column: "TransportationGroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLocations_Timestamp",
                table: "UserLocations",
                column: "Timestamp");
